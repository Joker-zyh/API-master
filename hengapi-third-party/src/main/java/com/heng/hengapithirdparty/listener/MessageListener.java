package com.heng.hengapithirdparty.listener;

import com.heng.hengapicommon.model.entity.SmsMessage;
import com.heng.hengapithirdparty.utils.SendMessageOperation;
...
import static com.heng.hengapicommon.constant.RabbitmqConstant.QUEUE_LOGIN_SMS;
...
public class MessageListener {
    ...
    public void receiveSms(SmsMessage smsMessage, Message message, Channel channel) throws IOException {
        ...
        messageOperation.sendMessage(smsMessage,stringRedisTemplate);
